...
#
#	Copyright © 1988, 1998 Apple Computer, Inc.
#	All rights reserved.
#
#	Versions:	1.0					8/88
#				1.01				9/16/92	GAB
#				1.02				6/10/98	GAB		compatible with 3.1 interfaces
#
...
resource 'WIND' (1000, "Tubeland") {
	{50, 10, 350, 610},
	documentProc, visible, noGoAway, 0x0, "Tubeland", noAutoCenter
};


resource 'DLOG' (1000, "About TubeTest…") {
	{90, 50, 180, 460},
	rDocProc, visible, noGoAway, 0x0, 1000, "TubeAbout", centerMainScreen
};
